...
//  HYAlertView
//
//  Created by heyuanXie on 2016/11/1.
//  Copyright © 2016年  heyuanXie inc. All rights reserved.
//
...
static char HYOriginalUIAlertViewDelegateKey;
static char HYAlertViewClickedButtonAtIndexBlockKey;
static char HYAlertViewCancelBlockKey;
static char HYWillPresentAlertViewBlockKey;
static char HYDidPresentAlertViewBlockKey;
static char HYAlertViewWillDismissWithButtonIndexBlockKey;
static char HYAlerViewDidDismissWithButtonIndexBlockKey;
static char HYAlertViewShouldEnableFirstOtherButtonBlockKey;
...
- (void)_useBlock {
    if (self.delegate && self.delegate != (id<UIAlertViewDelegate>)self) {
        ...
        objc_setAssociatedObject(self, &HYOriginalUIAlertViewDelegateKey, self.delegate, OBJC_ASSOCIATION_ASSIGN);
    }
 ...
 */
- (HYAlertViewCompleteBlock)alertViewClickedButtonAtIndexBlock {
    return objc_getAssociatedObject(self, &HYAlertViewClickedButtonAtIndexBlockKey);
}
/**
 * @brief 设置点击ClickedButton的Block
 */
- (void)setAlertViewClickedButtonAtIndexBlock:(HYAlertViewCompleteBlock)alertViewClickedButtonAtIndexBlock {
    if (alertViewClickedButtonAtIndexBlock) {
        [self _useBlock];
        objc_setAssociatedObject(self, &HYAlertViewClickedButtonAtIndexBlockKey, alertViewClickedButtonAtIndexBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
    }
 ...
 */
- (HYAlertViewBlock)alertViewCancelBlock{
    return objc_getAssociatedObject(self, &HYAlertViewCancelBlockKey);
}
/**
 * @brief 设置点击取消按钮的Block
 */
- (void)setAlertViewCancelBlock:(HYAlertViewBlock)alertViewCancelBlock {
    if (alertViewCancelBlock) {
        [self _useBlock];
        objc_setAssociatedObject(self, &HYAlertViewCancelBlockKey, alertViewCancelBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
    }
}
/**
 * 通过 objc_getAssociatedObject 点击WillPresentAlertView的关联对象
 */
- (HYAlertViewBlock)willPresentAlertViewBlock {
    return objc_getAssociatedObject(self, &HYWillPresentAlertViewBlockKey);
}
/**
 * @brief 设置WillPresentAlertView的Block
 */
- (void)setWillPresentAlertViewBlock:(HYAlertViewBlock)willPresentAlertViewBlock {
    if (willPresentAlertViewBlock) {
        [self _useBlock];
        objc_setAssociatedObject(self, &HYWillPresentAlertViewBlockKey, willPresentAlertViewBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
    }
}
/**
 * 通过 objc_getAssociatedObject 点击PresentAlertView的关联对象
 */
- (HYAlertViewBlock)didPresentAlertViewBlock {
    return objc_getAssociatedObject(self, &HYDidPresentAlertViewBlockKey);
}
/**
 * @brief 设置父类的AlertView的Block
 */
- (void)setDidPresentAlertViewBlock:(HYAlertViewBlock)didPresentAlertViewBlock {
    if (didPresentAlertViewBlock) {
        [self _useBlock];
        objc_setAssociatedObject(self, &HYDidPresentAlertViewBlockKey, didPresentAlertViewBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
    }
}

- (HYAlertViewCompleteBlock)alertViewWillDismissWithButtonIndexBlock {
    return objc_getAssociatedObject(self, &HYAlertViewWillDismissWithButtonIndexBlockKey);
}

- (void)setAlertViewWillDismissWithButtonIndexBlock:(HYAlertViewCompleteBlock)alertViewWillDismissWithButtonIndexBlock {
    if (alertViewWillDismissWithButtonIndexBlock) {
        [self _useBlock];
        objc_setAssociatedObject(self, &HYAlertViewWillDismissWithButtonIndexBlockKey, alertViewWillDismissWithButtonIndexBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
    }
}

-(HYAlertViewCompleteBlock)alerViewDidDismissWithButtonIndexBlock {
    return objc_getAssociatedObject(self, &HYAlerViewDidDismissWithButtonIndexBlockKey);
}

- (void)setAlerViewDidDismissWithButtonIndexBlock:(HYAlertViewCompleteBlock)alerViewDidDismissWithButtonIndexBlock {
    if (alerViewDidDismissWithButtonIndexBlock) {
        [self _useBlock];
    }
}

-(HYAlertViewBoolBlock)alertViewShouldEnableFirstOtherButtonBlock {
    return objc_getAssociatedObject(self, &HYAlertViewShouldEnableFirstOtherButtonBlockKey);
}

- (void)setAlertViewShouldEnableFirstOtherButtonBlock:(HYAlertViewBoolBlock)alertViewShouldEnableFirstOtherButtonBlock {
    if (alertViewShouldEnableFirstOtherButtonBlock) {
        [self _useBlock];
        objc_setAssociatedObject(self, &HYAlertViewShouldEnableFirstOtherButtonBlockKey, alertViewShouldEnableFirstOtherButtonBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
    }
}
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    HYAlertViewCompleteBlock block = self.alertViewClickedButtonAtIndexBlock;
    if (block) block(alertView, buttonIndex);

    id<UIAlertViewDelegate> original = objc_getAssociatedObject(self, &HYOriginalUIAlertViewDelegateKey);
...
- (void)alertViewCancel:(UIAlertView *)alertView {
    HYAlertViewBlock block = self.alertViewCancelBlock;
...
- (void)willPresentAlertView:(UIAlertView *)alertView {
    HYAlertViewBlock block = self.willPresentAlertViewBlock;
    if (block) block(alertView);
...
- (void)didPresentAlertView:(UIAlertView *)alertView {
    HYAlertViewBlock block = self.didPresentAlertViewBlock;
    if (block) block(alertView);
...
- (void)alertView:(UIAlertView *)alertView willDismissWithButtonIndex:(NSInteger)buttonIndex {
    HYAlertViewCompleteBlock block = self.alertViewWillDismissWithButtonIndexBlock;
    if (block) block(alertView, buttonIndex);
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex {
    HYAlertViewCompleteBlock block = self.alerViewDidDismissWithButtonIndexBlock;
    if (block) block(alertView, buttonIndex);
...
- (BOOL)alertViewShouldEnableFirstOtherButton:(UIAlertView *)alertView {
    ...
    HYAlertViewBoolBlock block = self.alertViewShouldEnableFirstOtherButtonBlock;
    if (block) {
...
+ (HYAlertView *) sharedInstance{

    static HYAlertView *sharedObj = nil;
    @synchronized (self)
    {
        if (sharedObj == nil){
