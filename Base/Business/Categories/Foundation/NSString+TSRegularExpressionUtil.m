//
//  NSString+TSRegularExpressionUtil.m
//  Base
//
...
static NSString * const  regular_mobileNum = @"^1(3|4|5|7|8)\\d{9}$";

static NSString * const  regular_RealName = @"^([\u4e00-\u9fa5]{2,20})|([a-zA-Z]{6,20})$";

static NSString * const  regular_Id = @"^([1-9]\\d{5}[1-9]\\d{3}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}([0-9]|X|x))$";//@"^([1-9]\\d{5}[1-9]\\d{3}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}([0-9]|X|x))|([A-Z]{1}[0-9]{6}\\(([0-9]{1}|A)\\))|([1-9]{1}[0-9]{6}\\([0-9]{1}\\))|(^[A-Z]{1}[0-9]{8,10})$";
...
@implementation NSString (TSRegularExpressionUtil)
