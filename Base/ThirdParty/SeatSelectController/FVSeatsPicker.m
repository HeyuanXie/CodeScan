...
//    _imageDict[@(UIControlStateSelected)] = [[UIImage imageWithContentsOfFile:source3] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    _imageDict[@(UIControlStateNormal)] = [ImageNamed(@"座位状态_可选") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    _imageDict[@(UIControlStateDisabled)] = [ImageNamed(@"座位状态_不可选") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    _imageDict[@(UIControlStateSelected)] = [ImageNamed(@"座位状态_已选") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
}
